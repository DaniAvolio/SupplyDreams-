...
export class ProdottoService {
  ...
  private _prodotti : Prodotto[] = [
    ...
    {aggiunto:false, slug:"prod3", nome:"proteine whey idrolizzate",
    ...
    {aggiunto:false, slug:"prod4", nome:"proteine whey concentrate",
    ...
    {aggiunto:false, slug:"prod5", nome:"creatina monoidrato @creapure",
    ...
    {aggiunto:false, slug:"prod6", nome:"creatina in capsule",
    ...
    {aggiunto:false, slug:"prod7", nome:"creatina monoidrato @creapure",
    ...
    {aggiunto:false, slug:"prod8", nome:"proteine whey isolate ",
    foto:"https://static.thcdn.com/images/large/webp//productimg/1600/1600/10530911-5884889444360331.jpg",
     ...
     {aggiunto:false, slug:"prod9", nome:"6x barrette proteiche ",
    foto:"https://static.sscontent.com/thumb/1000/1000/products/124/v1079517_prozis_12-x-protein-snack-30-g_cookies-and-cream_newin_flavor.jpg",
     ...
     {aggiunto:false, slug:"prod10", nome:"4x barrette proteiche ",
     foto:"https://static.thcdn.com/images/large/webp//productimg/1600/1600/13308982-3124937164978398.jpg",
      ...
      {aggiunto:false, slug:"prod11", nome:"proteine concentrate dell'uovo ",
      foto:"https://www.bulk.com/media/catalog/product/cache/1500x1500/e/g/egg-white-powder_bpb-ewp-0000_main.jpg",
       ...
       {aggiunto:false, slug:"prod12", nome:"6x barrette proteiche GyM",
